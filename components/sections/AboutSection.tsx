      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-12">
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-zinc-400 text-md leading-relaxed">
            I am a student at Bandung National Institute of Technology majoring
            in Informatics and I am currently exploring the integration of
            Artificial Intelligence (AI) to create innovative technological
            solutions.
          </p>
        </div>
